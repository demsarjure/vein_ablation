...
sum(rspv_rr) / length(rspv_rr) # 27.67 ± 8.07%
...
sum(rspv_ra) / length(rspv_ra) # 26.67 ± 9.28%
...
sum(rspv_rp) / length(rspv_rp) # 16.67 ± 6.74%
...
sum(ripv_ra) / length(ripv_ra) # 3.33 ± 3.26%
...
sum(ripv_rp) / length(ripv_rp) # 6.67 ± 4.58%
...
sum(lipv_li) / length(lipv_li) # 3.33 ± 3.25%
...
sum(lipv_lp) / length(lipv_lp) # 3.33 ± 3.3%
