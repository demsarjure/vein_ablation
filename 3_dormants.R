...
# set NA to 0
df_high_density$ripv_ra <-
    ifelse(is.na(df_high_density$ripv_ra), 0, df_high_density$ripv_ra)
df_high_density$lipv_li <-
    ifelse(is.na(df_high_density$lipv_li), 0, df_high_density$lipv_li)
