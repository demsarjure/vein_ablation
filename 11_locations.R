...
for (i in 1:nrow(df_all)) {
    ...
    if (df_all[i, "rspv_rr"] >= 1 && df_all[i, "dormant_rspv_rr"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "rspv_rr"] >= 1 && df_all[i, "dormant_rspv_rr"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "rspv_ra"] >= 1 && df_all[i, "dormant_rspv_ra"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "rspv_ra"] >= 1 && df_all[i, "dormant_rspv_ra"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "rspv_rp"] >= 1 && df_all[i, "dormant_rspv_rp"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "rspv_rp"] >= 1 && df_all[i, "dormant_rspv_rp"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "ripv_ra"] >= 1 && df_all[i, "dormant_ripv_ra"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "ripv_ra"] >= 1 && df_all[i, "dormant_ripv_ra"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "ripv_rp"] >= 1 && df_all[i, "dormant_ripv_rp"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "ripv_rp"] >= 1 && df_all[i, "dormant_ripv_rp"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "ripv_ri"] >= 1 && df_all[i, "dormant_ripv_ri"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "ripv_ri"] >= 1 && df_all[i, "dormant_ripv_ri"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "lspv_lr"] >= 1 && df_all[i, "dormant_lspv_lr"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "lspv_lr"] >= 1 && df_all[i, "dormant_lspv_lr"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "lspv_lrg"] >= 1 && df_all[i, "dormant_lspv_lrg"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "lspv_lrg"] >= 1 && df_all[i, "dormant_lspv_lrg"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "lspv_lp"] >= 1 && df_all[i, "dormant_lspv_lp"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "lspv_lp"] >= 1 && df_all[i, "dormant_lspv_lp"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "lipv_la"] >= 1 && df_all[i, "dormant_lipv_la"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "lipv_la"] >= 1 && df_all[i, "dormant_lipv_la"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "lipv_li"] >= 1 && df_all[i, "dormant_lipv_li"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "lipv_li"] >= 1 && df_all[i, "dormant_lipv_li"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
    ...
    if (df_all[i, "lipv_lp"] >= 1 && df_all[i, "dormant_lipv_lp"] >= 1) {
        match[j] <- 1
        j <- j + 1
    } else if (df_all[i, "lipv_lp"] >= 1 && df_all[i, "dormant_lipv_lp"] == 0) {
        match[j] <- 0
        j <- j + 1
    }
}
