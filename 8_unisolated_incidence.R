...
# rspv_ra ----------------------------------------------------------------------
# close: 13.33 ± 6.19%, high_density: 6.9 ± 4.7%
...
# rspv_rp ----------------------------------------------------------------------
# close: 10 ± 5.47%, high_density: 6.9 ± 4.7%
...
# lspv_lr ----------------------------------------------------------------------
# close: 3.33 ± 3.25%, high_density: 3.45 ± 3.38%
...
# close: 2 ± 1.37, high_density: 1 ± 0.98
length(close) - sum(close)
boot_sd_sum(1 - close)
...
# lipv_la ----------------------------------------------------------------------
# close: 6.67 ± 4.54%, high_density: 0
...
# lipv_li ----------------------------------------------------------------------
# close: 0, high_density: 3.45 ± 3.38%
...
# rspv -------------------------------------------------------------------------
# close: 10.83 ± 2.81%, high_density: 3.45 ± 1.72%
close <- c(
...
# close: 13 ± 3.41, high_density: 4 ± 1.96
length(close) - sum(close)
boot_sd_sum(1 - close)
...
# ripv -------------------------------------------------------------------------
# close: 5.83 ± 2.12%, high_density: 0
close <- c(
...
# lspv -------------------------------------------------------------------------
# close: 3.33 ± 1.63%, high_density: 2.59 ± 1.46%
close <- c(
...
# close: 4 ± 1.98, high_density: 3 ± 1.72
length(close) - sum(close)
boot_sd_sum(1 - close)
...
# lipv -------------------------------------------------------------------------
# close: 2.5 ± 1.42%, high_density: 1.72 ± 1.21%
close <- c(
...
# close: 3 ± 1.72, high_density: 2 ± 1.41
length(close) - sum(close)
boot_sd_sum(1 - close)
